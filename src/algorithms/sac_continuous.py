...
class SacCountinuous():
    def __init__(self, state_dim, action_dim, net_width, gamma, a_lr, c_lr, alpha, batch_size, dvc, adaptive_alpha):
        # put the input parameters into this inst in a elegant way
    ...
    def load(self, actor_file_name, critic_file_name):
        self.actor.load_state_dict(torch.load(
            actor_file_name, map_location=self.dvc))
        self.q_critic.load_state_dict(torch.load(
            critic_file_name, map_location=self.dvc))
